...
public class InitData
{
    ...
    public static List<Post> LoadPosts()
    {
        ...
        posts.Add(new Post
        {
            ...
            Content =
                "Proin finibus sodales purus, et luctus urna laoreet ullamcorper. Donec vitae dapibus massa. Suspendisse id maximus risus",
            Status = false
        });
        posts.Add(new Post
        {
            ...
            Title = "New's",
            Content =
                "Fusce iaculis sem nec tellus suscipit congue. Etiam pharetra posuere porta. Mauris semper quam ut sapien pharetra laoreet. Donec ultrices",
            Status = true
        });
        return posts;
    }
    ...
    {
        var postLabelPivots = new List<PostLabelPivot>();
