...
namespace BlogApplication.Migrations
{
    ...
    [Migration("20220913025921_AddAllDataSchemas")]
    partial class AddAllDataSchemas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogApplication.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PublicationDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 9, 12, 21, 59, 21, 567, DateTimeKind.Local).AddTicks(9465))
            ...
            modelBuilder.Entity("BlogApplication.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("PublicationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 9, 12, 21, 59, 21, 567, DateTimeKind.Local).AddTicks(6669))
                        .HasColumnName("Publication_date");
            ...
            modelBuilder.Entity("BlogApplication.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 9, 12, 21, 59, 21, 567, DateTimeKind.Local).AddTicks(3038))
                    ...
                    b.Property<DateTime>("UpdateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 9, 12, 21, 59, 21, 567, DateTimeKind.Local).AddTicks(3276))
